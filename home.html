        ...
        <header>
            <div class="container">
                <nav class="navbar navbar-expand-lg navbar-dark">
                    <a class="navbar-brand" href="#home">Tech-Reclaim</a>
                ...
                <div class="row">
                    <div class="col-lg-6 align-item-center">
                        <div class="home-info">
                            ...
                            <h2>We <span>TECH RECLAIM</span> manage e-wastage for needy peoples</h2>
                            <p>Transforming Electronic Waste into Opportunities</p>
                            <div class="buttons">
                                <a href="#contact" class="btn1">sell now</a>
                            </div>
                        </div>
                    </div>
                    <div class="col-lg-6 order-first order-lg-last">
                        <div class="img-sec" id="img-sec1">
                            <img src="img/img-5.jpg" alt="home-image" height="500px" width="600">
                        </div>
                    </div>
                </div>
            </div>
