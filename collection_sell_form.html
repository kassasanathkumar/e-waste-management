...
<body>
    ...
    <div id="container_1">
        <div id="container_2">
            <form action="./collection_form.php" method="post" class="registration-form" id="registration-form-1">
            <div class="form-group">
                    <label for="name" id="name">name:</label>
                    <input type="text" id="name" name="name" class="input" required>
                </div>
                <div class="form-group">
                    <label for="collection_center" id="collection_center">comapny name:</label>
                    <input type="text" id="collection_center" name="company_name" class="input" required>
                </div>
                <div class="form-group">
                ...
                <div class="form-group">
                    <label for="estimated_cost">estimated cost:(ruppes)</label>
                    <input type="text" id="estimated_cost" name="estimated_cost" class="input" required>
                </div>
                ...
                <div class="form-group">
                    <label for="weight">estimated weight:(in KGs)</label>
                    <input type="int" id="estimated_weight" name="estimated_weight" class="input" required>
                </div>
