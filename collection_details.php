...
$sql = "SELECT * FROM collection_centers WHERE town LIKE '%" . $searchTerm . "%'"; // Modify column_name
...
if ($result->num_rows > 0) {
    ...
    while($row = $result->fetch_assoc()) {
        echo "<tr>";
        echo "<td>" . $row["id"]. "</td><td>" . $row["name"]. "</td><td>" . $row["phone"]. "</td><td>" . $row["town"]. "</td><td>" . $row["district"]. "</td><td>" . $row["state"]. "</td>";
        echo "</tr>";
...
<div>
    <a href="./single_home_page.php"><button type="button">Return to Home Page</button></a>
    </div>
